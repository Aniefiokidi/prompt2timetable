  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 z-50 flex justify-end">
      <div className="w-full max-w-md bg-white h-full shadow-xl p-6 overflow-y-auto relative animate-slidein border-l-8 border-cu-purple">
        ...
        <div className="mb-2">Lecturer: <span className="font-medium">{course.lecturer}</span></div>
        <div className="mb-2">Room: <span className="font-medium">{course.room}</span></div>
